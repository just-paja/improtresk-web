...
describe('Workshop transformers', () => {
  ...
  it('aggregateWorkshopCapacityData returns null when capacity is not available', () => {
    expect(transformers.aggregateWorkshopCapacityData(5)).to.eql(null);
  });
  it('aggregateWorkshopCapacityData returns null with unknown workshop id', () => {
    expect(transformers.aggregateWorkshopCapacityData(5, [])).to.eql(null);
  });
  it('aggregateWorkshopCapacityData returns capacity status', () => {
    expect(transformers.aggregateWorkshopCapacityData(5, [
      {
        id: 5,
        capacity: 12,
  ...
  it('aggregateWorkshopCapacityData returns zero free spots with overcrowded workshop', () => {
    expect(transformers.aggregateWorkshopCapacityData(5, [
      {
        id: 5,
        capacity: 12,
  ...
  it('aggregateWorkshopCapacityData returns fully assigned status', () => {
    expect(transformers.aggregateWorkshopCapacityData(5, [
      {
        id: 5,
        capacity: 12,
  ...
  it('aggregateWorkshopCapacityData returns fully reserved status', () => {
    expect(transformers.aggregateWorkshopCapacityData(5, [
      {
        id: 5,
        capacity: 12,
